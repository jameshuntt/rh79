        ...
        return (
            <div style={{ width: '100vw', background: 'black', color: 'white' }}>
                <Container>
                    <Row>
                        <Col>
                            <h3>Guilderland High School Class of 79 Golf Tournaments</h3>
                        </Col>
                        <Col>
                            <p>
                                random stuff random stuffrandom stuff random stuffrandom stuff random stuffrandom stuff random stuff
                                random stuff random stuffrandom stuff random stuffrandom stuff random stuffrandom stuff random stuff
                            </p>
                        </Col>
                        <Col>
